...
export default function OpportunityCard({ op, tipos = [], onChangeEstado, onUpdate }) {
  const base = op.base || {};
    ...
    <div className="rounded-xl border border-gray-300 bg-white p-4 hover:bg-gray-50 transition-colors">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
        ...
        {!edit ? (
          ...
          <>
            <div>
              <div className="text-[10px] uppercase text-gray-500">Monto (S/.)</div>
              <input
                type="number"
            ...
            <div>
              <div className="text-[10px] uppercase text-gray-500">Cantidad (Q)</div>
              <input
                type="number"
                className="mt-1 w-full border border-gray-300 rounded px-2 py-1 text-sm"
                value={cantidad}
