...
// ⬅️ Ajusta este import si tu archivo se llama distinto (p.ej. ReportFilters.jsx)
  ...
  return (
    <div className="p-6 min-h-dvh bg-gradient-to-b from-slate-100 to-slate-50">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-3">
        <Box
          title="Línea de progreso (Oportunidades por día)"
                ...
                <PieChart>
                  ...
                  >
                    {dist.map((_, i) => (
                      <Cell
                        key={i}
                        fill={REPORT_COLORS[i % REPORT_COLORS.length]}
                      />
                    ))}
                    <LabelList
                      dataKey="__pct"
